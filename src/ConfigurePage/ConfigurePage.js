...
function ConfigurePage({ updateHomePageData }) {
  ...
  const handleAllocationSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://charanbackendapi.onrender.com/api/configure-budget', budgetData);
  ...
  const handleDeallocationSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://charanbackendapi.onrender.com/api/deallocation-budget', deallocateData);
      console.log(response.data);
